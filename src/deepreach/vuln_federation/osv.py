...
class OSVAdapter(SourceAdapter):
    ...
    def _parse_osv_vulnerability(self, vuln: dict, ecosystem: str) -> Optional[Advisory]:
        ...
        try:
            ...
            if not cve_id.startswith("CVE-"):
                ...
                cve_candidates = [alias for alias in aliases if alias.startswith("CVE-")]
            ...
            for aff in affected:
                if aff.get("package", {}).get("name") == package_name or not package_name:
            ...
            # In a full implementation, we would parse CVSS scores from database_specific
